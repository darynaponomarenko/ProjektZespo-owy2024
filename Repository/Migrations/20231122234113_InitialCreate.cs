    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Appointments_Room_RoomNumber",
            ...
            migrationBuilder.InsertData(
                table: "Patient",
                columns: new[] { "Id", "DateOfBirth", "Discriminator", "Email", "Name", "Pesel", "PhoneNumber", "Surname" },
                values: new object[,]
                {
                    { 1, new DateTime(2003, 7, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Patient", "test@gmail.com", "TestName1", null, "1234567890", "TestSurname" },
                    { 2, new DateTime(1998, 11, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "Patient", "test2@gmail.com", "TestName2", null, "1234567098", "TestSurname2" },
                    { 3, new DateTime(1978, 3, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "Patient", "test1@gmail.com", "TestName3", null, "123456000", "TestSurname1" }
                });
